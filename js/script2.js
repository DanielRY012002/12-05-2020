...
function calcular(){
    ...
    var operacion=new Operaciones(document.getElementById("n1").value,document.getElementById("n2").value,document.getElementById("opc").value);
